<%@ Page Language="C#" AutoEventWireup="true" CodeFile="feedback_success.aspx.cs" Inherits="feedback_success" %>
...
<body style="background-image:url(Site_images/image5.jpg);background-repeat:no-repeat;
    ...
    <div  style="margin-top:20em">
        <center><h1><strong>THANK YOU FOR YOUR VALUABLE FEEDBACK.</strong></h1>
            <br/><br/>
