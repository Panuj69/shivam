...
public class db
{
    SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["db_games_n_books_ConnectionString"].ConnectionString);
    ...
    //    string un = "topdesk@gmail.com";    //topdesk email
    //    string pas = "Topdeskadmin";        //topdesk password
    ...
    //    };
    //    MailMessage m = new MailMessage(un, rec, subject, body);
    //    m.IsBodyHtml = true;
    //    client.Send(m);
