<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="addattribute.aspx.cs" Inherits="addattribute" %>
    ...
    <table style="width: 100%;" cellpadding="5px">
        <tr>
            <td colspan="3" style="font-weight: 700;font-size:x-large">
                <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ADD ATTRIBUTE</strong></td>
        </tr>
        <tr>
            <td class="style2">
                &nbsp;
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ...
                    ValidationGroup="O"></asp:RequiredFieldValidator>
&nbsp;<asp:Label ID="Label2" runat="server" Text="Already available." Visible="False"></asp:Label>
        ...
        <tr>
            <td class="style2">
                &nbsp;</td>
            <td class="style3">
                <asp:Button ID="Button1" runat="server" Text="ADD" ValidationGroup="O" 
